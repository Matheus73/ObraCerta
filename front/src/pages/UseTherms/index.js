        ...
        <PageDefault>
           <Container>
                ...
                <h2>Política Privacidade</h2>
                    ...
                    <p>A sua privacidade é importante para nós.É política do Obra Certa respeitar a sua privacidade em relação
                a qualquer informação sua que possamos coletar no site <a href="https://github.com/Matheus73/ObraCerta">Obra Certa</a>,
                e outros sites que possuímos e operamos.
                    ...
                    que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade
                    por suas respectivas <a href='https://politicaprivacidade.com' target='_BLANK' rel="noopener noreferrer">políticas de privacidade</a>.
                    </p>
                ...
                <h3>Compromisso do Usuário</h3>
                    ...
                    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Obra Certa oferece
                    ...
                    <ul>
                        ...
                        <li>B- Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica,
                            <a href='https://ondeapostar.pt/'>casas de apostas</a>,
                            pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                        </li>
                        <li>C- Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Obra Certa,
                ...
                <h2>1. Termos</h2>
                <p>Ao acessar ao site <a href='https://github.com/Matheus73/ObraCerta'>Obra Certa</a>, concorda em cumprir estes termos de serviço, todas as
                ...
                <p>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software)
                    no site Obra Certa , apenas para visualização transitória pessoal e não comercial. Esta é a concessão
                    de uma licença, não uma transferência de título e, sob esta licença, você não pode: </p>
                    <ol>
                        <li>modificar ou copiar os materiais;  </li>
                        <li>usar os materiais para qualquer finalidade comercial ou para exibição pública (comercial ou não comercial);  </li>
                        <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Obra Certa;  </li>
                    ...
                    <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser
                        rescindida por Obra Certa a qualquer momento. Ao encerrar a visualização desses materiais ou após
                    ...
                    <ol>
                        <li>Os materiais no site da Obra Certa são fornecidos 'como estão'. Obra Certa não oferece garantias,
                            ...
                            <li>Além disso, o Obra Certa não garante ou faz qualquer representação relativa à precisão,
                    ...
                    <h2>4. Limitações</h2>
                    <p>Em nenhum caso o Obra Certa ou seus fornecedores serão responsáveis ​​por quaisquer danos
                        (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios)
                        decorrentes do uso ou da incapacidade de usar os materiais em Obra Certa, mesmo que Obra Certa
                        ou um representante autorizado da Obra Certa tenha sido notificado oralmente ou por escrito da
                        ...
                        não se aplicar a você.</p>
                    <h2>5. Precisão dos materiais</h2>
                    <p>Os materiais exibidos no site da Obra Certa podem incluir erros técnicos, tipográficos ou fotográficos.
                        Obra Certa não garante que qualquer material em seu site seja preciso, completo ou atual.
                        Obra Certa pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso
                        prévio. No entanto, Obra Certa não se compromete a atualizar os materiais.</p>
                    <h2>6. Links</h2>
                    <p>O Obra Certa não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo
                        de nenhum site vinculado. A inclusão de qualquer link não implica endosso por Obra Certa do site.
                        O uso de qualquer site vinculado é por conta e risco do usuário.</p>
                    <h3>Modificações</h3>
                        <p>O Obra Certa pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio.
                            Ao usar este site, você concorda em ficar vinculado à versão atual desses termos de serviço.
                        </p>
                    <h3>Lei aplicável</h3>
                    <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Obra Certa e você se
